...
import com.decamincow.practice.controller.service.EmailServiceFeignClient;
import com.decamincow.practice.dao.CodeDao;
import com.decamincow.practice.model.AuthCode;
import com.decamincow.practice.service.CodeService;
...
public class CodeServiceImpl implements CodeService {
    ...
    public boolean createCode(AuthCode authCode) {
        ...
        try {
            ...
            emailServiceFeignClient.sendEmail(authCode.getEmail(), authCode.getCode());
        } catch (Exception e) {
            e.printStackTrace();
